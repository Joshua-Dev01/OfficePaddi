...
import Hero from "/service-page/service-dropdown/crm/HeroImg.svg";
import Engagement from "/service-page/service-dropdown/crm/engagementIcon.svg";
import Management from "/service-page/service-dropdown/crm/managementIcon.svg";
import Compliance from "/service-page/service-dropdown/crm/retention.svg";
import { Footer } from "../../Footer/Footer";
import ChoosePlan from "./ChoosePlan";
import CrmComp from "./CrmComp"
import { Crmflex } from "./Crmflex";
export const Crm = () => {
  return (
    <>
      <div className="absolute top-[10rem] ">
        ...
        <div className="flex flex-wrap items-center justify-around mt-36 bg-green text-white py-10 leading-10 ">
