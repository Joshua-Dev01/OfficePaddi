...
export const Services = () => {
  return (
    <>
      {/* *****************************************WHAT WE DO****************************** */}
      <div className="relative top-[10rem] text-center text-[0D333E] mb-[15rem]">
        <p className="font-bold">SERVICES</p>
        <h1 className="text-2xl">What We DO </h1>
        <p>
          Jorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc
          vulputate <br /> libero et velit interdum, ac aliquet odio mattis
        </p>
      ...
      {/* ************SERVE YOU*********** */}
      <div className="flex items-center justify-center text-center gap-9 mx-16 xs:grid xs:grid-cols-2 xsm:block">
        {/* ************HRM*********** */}
        <div>
          <img src={CustormizedHRM} alt="" />
          <p className="text-[1.2rem] font-semibold my-5">Customized HRM </p>
          <p>
      ...
      <div className="text-center relative top-[5rem] bg-[#0D333E] text-white py-10 mb-32">
        ...
        <p className="text-[#0FD46C] my-5 font-semibold">Buy Now and Manage</p>
      ...
      <div>
        ...
        <div className="flex items-center justify-center my-14 gap-14 mx-24 xs:grid xs:grid-cols-2 xsm:block">
          <div>
            <img src={system} alt="" />
      ...
      <div>
        ...
        <div className="greenBG text-center relative top-[5rem] text-white py-10 mb-32">
          <h1 className="text-[30px]">See What Wokrr Can do</h1>
